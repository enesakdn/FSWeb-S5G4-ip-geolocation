...
function data(nesne) {
  ...
  var div2olustur = document.createElement("div");
  div2olustur.setAttribute("class", "card-info");
  divolustur.appendChild(div2olustur);
  var h3olustur = document.createElement("h3");
  h3olustur.setAttribute("class", "ip");
  h3olustur.textContent = nesne.sorgu;
  div2olustur.appendChild(h3olustur);
  var polustur = document.createElement("p");
  polustur.setAttribute("class", "ulke");
  polustur.textContent = "".concat(nesne.ülke, " (").concat(nesne.ülkeKodu, ")");
  div2olustur.appendChild(polustur);
  var p1olustur = document.createElement("p");
  p1olustur.textContent = "Enlem: ".concat(nesne.enlem, " Boylam: ").concat(nesne.boylam);
  div2olustur.appendChild(p1olustur);
  var p2olustur = document.createElement("p");
  p2olustur.textContent = "\u015Eehir: ".concat(nesne.şehir);
  div2olustur.appendChild(p2olustur);
  var p3olustur = document.createElement("p");
  p3olustur.textContent = "Saat dilimi: ".concat(nesne.saatdilimi);
  div2olustur.appendChild(p3olustur);
  var p4olustur = document.createElement("p");
  p4olustur.textContent = "Para birimi: ".concat(nesne.parabirimi);
  div2olustur.appendChild(p4olustur);
  var p5olustur = document.createElement("p");
  p5olustur.textContent = "ISP: ".concat(nesne.isp);
